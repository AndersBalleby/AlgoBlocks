export default function TestCase({
  ...
  // Base classes
  const baseClasses =
    "flex items-center gap-[10px] px-[0.85rem] py-[0.6rem] border rounded-[8px] select-none transition-[background,border-color] duration-[150ms] ease-[ease]";
  ...
  const statusClasses = {
    ...
    default:
      "bg-[#f8fafc] border-[#e8ecf4] text-[#64748b] cursor-pointer hover:bg-[#f1f5f9] hover:border-[#c7d2e8]",
  };
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={bubbleClasses[status] || bubbleClasses.default}
          style={{
            width: "100%",
            height: "100%",
            display: "flex",
      ...
      <div className="flex-1 flex flex-col gap-0.5 min-w-0">
        ...
        >
          Søg efter{" "}
          <em
            style={{ fontStyle: "normal", color: "#6366f1", fontWeight: 700 }}
          >
            {target}
          </em>{" "}
          →{" "}
